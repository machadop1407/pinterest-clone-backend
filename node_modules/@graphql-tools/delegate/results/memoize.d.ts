...
export declare function memoizeInfoAnd2Objectsand1Primitive<T1 extends GraphQLResolveInfo, T2 extends Record<string, any>, T3 extends Record<string, any>, T4 extends string, R extends any>(fn: (A1: T1, A2: T2, A3: T3, A4: T4) => R): (A1: T1, A2: T2, A3: T3, A4: T4) => R;
