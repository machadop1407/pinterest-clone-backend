...
var GraphQLBase = (function (_super) {
    ...
    GraphQLBase.prototype.getWrappedInstance = function () {
        process.env.NODE_ENV === "production" ? tsInvariant.invariant(this.withRef, 30) : tsInvariant.invariant(this.withRef, "To access the wrapped instance, you need to specify " +
...
function withApollo(WrappedComponent, operationOptions) {
    ...
    var WithApollo = (function (_super) {
        ...
        WithApollo.prototype.getWrappedInstance = function () {
            process.env.NODE_ENV === "production" ? tsInvariant.invariant(operationOptions.withRef, 31) : tsInvariant.invariant(operationOptions.withRef, "To access the wrapped instance, you need to specify " +
                "{ withRef: true } in the options");
            return this.wrappedInstance;
        };
