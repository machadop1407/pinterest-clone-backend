    ...
    SchemaLink.prototype.request = function (operation) {
        ...
        return new utilities.Observable(function (observer) {
            new Promise(function (resolve) { return resolve(typeof _this.context === 'function'
                ...
                : _this.context); }).then(function (context) { return execute.execute(_this.schema, operation.query, _this.rootValue, context, operation.variables, operation.operationName); }).then(function (data) {
                if (!observer.closed) {
                    observer.next(data);
                    observer.complete();
                }
